...
mkValidator dat () ctx = 
    (traceIfFalse "deadline has already passed" signedByBeneficiary1 && beforeOrAtDeadline) ||
    (traceIfFalse "deadline hasn't passed yet" signedByBeneficiary2 && not beforeOrAtDeadline)
  where
    info :: TxInfo
